        ...
        <div className={s.wrapper}>
            ...
            <div className={s.high_block}>
                <div className={s.high_block_descrip}>
                    ...
                    <p className={s.title2}>Выполнение работ по озеленению территории</p>
                    <div className={s.abzac_block}>
                        ...
                        <p>разбивка территории в натуре в соответствии с проектом мест под посадку деревьев из Европы,</p>
