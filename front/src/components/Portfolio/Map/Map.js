            ...
            <div className={s.map_block}>
                ...
                <div className={s.map_descrip}>
                    ...
                    <div className={s.row}>
                            ...
                            <div className={s.address}>
                                <span>	Москва, Багратионовский пр., 5, корп. 1</span>
                            </div>
                        </div>
                    ...
                    <div className={s.row}>
                        ...
                        <div className={s.row}>
                            ...
                            <div className={s.address}>
                                <span>	Московская область, Химки, Ленинградская улица, <br/>39, стр. 6</span>
                            </div>
                        </div>
                    ...
                    <div className={s.row}>
                        ...
                        <div className={s.row}>
                            ...
                            <div className={s.address}>
                                <span>	Новая Москва, д. Рассказовка, уч. 13/2, корп. 1-13</span>
                            </div>
                        </div>
