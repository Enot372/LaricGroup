         ...
         <div className={s.questions}>
             <div className={s.header}>
                 ...
                 <div className={s.question_items}>
                     ...
                     <div>Насколько сложно и дорого будет обслуживать готовый объект?</div>
                     <div>Какой стиль оформления сейчас в моде?</div>
                 </div>
             </div>
             <form className={s.forma_wrapper}  onSubmit={handleSubmit(onSubmit)}>
                 ...
                 <div className={s.order_inputs_low}>
                     ...
                     <input type="submit" value="связаться" className={s.btn_call} onClick={()=>handleData}/>
                 </div>
             </form>
         </div>
     </div>
